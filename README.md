This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-twilio.

Cenit is an open source social platform as a service for data and business integration.

# CenitCollectionTwilio
...
Or install it yourself as:
    ...
    $ gem install cenit-collection-twilio
...
% tree
.
├── cenit-collection-cenit-collection-twilio.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-twilio
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-twilio.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-twilio_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
...
1. Fork it ( https://github.com/[my-github-username]/cenit-collection-twilio/fork )
